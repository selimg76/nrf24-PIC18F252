...
#define NOP             (0b11111111)   // name can be changed because of conflict in mcu header
...
#define STATUS           (0x07)  //Status Register name  can be changed because of conflict in mcu header
